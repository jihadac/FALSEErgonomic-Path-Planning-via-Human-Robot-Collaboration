...
class Draw:
    ...
    def draw_final(self,counter,colors,a,b,c,step,height_circle,distance_circle):
        ...
        tuples, a, c = points.candidatePoints(a,b,c,distance_circle,height_circle,step) #Give as argument value of radius. X and Z are the arrays of x- and z-coordinates of the points indicated in the circle.
        list_c = colors
