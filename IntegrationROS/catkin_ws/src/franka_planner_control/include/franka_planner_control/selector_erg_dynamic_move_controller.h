...
class SelectorErgDynamicMoveController : public franka_planner_control::ExplicitReferenceGovernor{
 public:
  ...
  /* receive robot reference pose orientation problem in rviz */
  ros::Subscriber rviz_orientation_problem_sub_; 
  void rvizOrientationProblemCallback(const std_msgs::Int8& msg); 
  int rviz_orientation_problem_; // 0 = false, 1 = true
