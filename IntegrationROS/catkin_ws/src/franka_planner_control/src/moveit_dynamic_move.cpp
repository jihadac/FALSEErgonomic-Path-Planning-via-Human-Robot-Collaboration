...
{
  ros::init(argc, argv, "moveit_dynamic_move");
  ...
  while(ros::ok()){
    ...
    if(elapsed_time_.toSec() <= 2.0){
    ...
    else if(elapsed_time_.toSec() > 2.0 && elapsed_time_.toSec() <= 9.0){
    ...
    else if(elapsed_time_.toSec() > 9.0 && elapsed_time_.toSec() <= 16.0){
    ...
    else if(elapsed_time_.toSec() > 16.0 && elapsed_time_.toSec() <= 23.0){
    ...
    else if(elapsed_time_.toSec() > 23.0 && elapsed_time_.toSec() <= 30.0){
      ...
      target_pose_.position.z = 0.590259; 
    ...
    if(!executing_plan && elapsed_time_.toSec() > 2.0){
      ...
      visual_tools.deleteAllMarkers();
      // visual_tools.publishAxisLabeled(target_pose_, "pose");
      ...
      /* execute */
      if(iter1==10 || iter2==10 || iter3==10 || iter4==10 || iter5==10){
