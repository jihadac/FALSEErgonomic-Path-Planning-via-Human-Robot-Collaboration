import sys
sys.path.insert(0, '/home/mainuser/Jihad/catkin_ws/src/algorithm/src/Fabrik')
import Execution_Fabrik as fabrik
...
def computeScores(tuples,distance_circle):
    ...
    for i in range(length):
        ...
        path = '/home/mainuser/Jihad/catkin_ws/src/algorithm/src/Fabrik/inputs/target.txt'
