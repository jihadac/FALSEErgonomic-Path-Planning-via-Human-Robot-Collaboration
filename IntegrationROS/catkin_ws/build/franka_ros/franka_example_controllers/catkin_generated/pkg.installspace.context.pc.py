...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_example_controllers;/home/mainuser/Jihad/libfranka/build/libfranka.so.0.7.1".split(';') if "-lfranka_example_controllers;/home/mainuser/Jihad/libfranka/build/libfranka.so.0.7.1" != "" else []
