...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_state_controller;-lfranka_control_services;/home/mainuser/Jihad/libfranka/build/libfranka.so.0.7.1".split(';') if "-lfranka_state_controller;-lfranka_control_services;/home/mainuser/Jihad/libfranka/build/libfranka.so.0.7.1" != "" else []
