...
#include "../../../../../src/zed-ros-example/rviz-plugin-zed-od/src/plugin/include/zed_od_display.hpp"
...
void rviz_plugin_zed_od::displays::ZedOdDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ZedOdDisplay *_t = static_cast<ZedOdDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject rviz_plugin_zed_od::displays::ZedOdDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<zed_interfaces::ObjectsStamped>::staticMetaObject, qt_meta_stringdata_rviz_plugin_zed_od__displays__ZedOdDisplay.data,
      qt_meta_data_rviz_plugin_zed_od__displays__ZedOdDisplay,  qt_static_metacall, nullptr, nullptr}
};
