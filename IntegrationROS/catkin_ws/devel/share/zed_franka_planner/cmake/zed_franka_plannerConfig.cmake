...
if(NOT "/home/mainuser/Jihad/catkin_ws/devel/include;/home/mainuser/Jihad/libfranka/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'zed_franka_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mainuser/Jihad/catkin_ws/src/zed_franka_planner/${idir}'.  ${_report}")
    endif()
