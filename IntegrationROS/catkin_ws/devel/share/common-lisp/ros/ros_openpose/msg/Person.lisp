...
(cl:ensure-generic-function 'faceParts-val :lambda-list '(m))
(cl:defmethod faceParts-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_openpose-msg:faceParts-val is deprecated.  Use ros_openpose-msg:faceParts instead.")
  (faceParts m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Person>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'faceParts))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'faceParts))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Person>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'faceParts) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'faceParts)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'ros_openpose-msg:BodyPart))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person>)))
  ...
  "719781611105baee252c1ac007e97ed7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person)))
  "Returns md5sum for a message object of type 'Person"
  "719781611105baee252c1ac007e97ed7")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Person>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'faceParts) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Person>))
  ...
  (cl:list 'Person
    ...
    (cl:cons ':faceParts (faceParts msg))
))
