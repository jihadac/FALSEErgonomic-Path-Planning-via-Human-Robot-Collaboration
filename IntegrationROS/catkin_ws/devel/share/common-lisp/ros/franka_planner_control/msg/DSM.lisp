...
(cl:defclass <DSM> (roslisp-msg-protocol:ros-message)
  ((time
   ...
   (dotp_EE
    ...
    :initform 0.0)
   (terminalenergy
    :reader terminalenergy
    :initarg :terminalenergy
    :type cl:float
    :initform 0.0)
   (sphere
    :reader sphere
...
(cl:defmethod cl:initialize-instance :after ((m <DSM>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DSM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name franka_planner_control-msg:<DSM> is deprecated: use franka_planner_control-msg:DSM instead.")))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <DSM>))
...
(cl:defmethod dotp_EE-val ((m <DSM>))
...
(cl:ensure-generic-function 'terminalenergy-val :lambda-list '(m))
(cl:defmethod terminalenergy-val ((m <DSM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_planner_control-msg:terminalenergy-val is deprecated.  Use franka_planner_control-msg:terminalenergy instead.")
  (terminalenergy m))

(cl:ensure-generic-function 'sphere-val :lambda-list '(m))
(cl:defmethod sphere-val ((m <DSM>))
...
(cl:defmethod cylinder-val ((m <DSM>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DSM>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'dotp_EE))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'terminalenergy))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DSM>) istream)
  "Deserializes a message object of type '<DSM>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'terminalenergy) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DSM>)))
  ...
  (cl:format cl:nil "float64 time~%float64 DSM~%float64 tau~%float64 dotq~%float64 q~%float64 dotp_EE~%float64 terminalenergy~%float64 sphere~%float64 cylinder~%float64 wall~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DSM)))
  "Returns full string definition for message of type 'DSM"
  (cl:format cl:nil "float64 time~%float64 DSM~%float64 tau~%float64 dotq~%float64 q~%float64 dotp_EE~%float64 terminalenergy~%float64 sphere~%float64 cylinder~%float64 wall~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DSM>))
  ...
  (cl:list 'DSM
    ...
    (cl:cons ':terminalenergy (terminalenergy msg))
