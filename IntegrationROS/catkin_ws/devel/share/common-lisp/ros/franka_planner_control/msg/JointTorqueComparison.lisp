...
(cl:defmethod cl:initialize-instance :after ((m <JointTorqueComparison>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTorqueComparison)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name franka_planner_control-msg:<JointTorqueComparison> is deprecated: use franka_planner_control-msg:JointTorqueComparison instead.")))

(cl:ensure-generic-function 'tau_error-val :lambda-list '(m))
(cl:defmethod tau_error-val ((m <JointTorqueComparison>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_planner_control-msg:tau_error-val is deprecated.  Use franka_planner_control-msg:tau_error instead.")
  (tau_error m))
...
(cl:defmethod root_mean_square_error-val ((m <JointTorqueComparison>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_planner_control-msg:root_mean_square_error-val is deprecated.  Use franka_planner_control-msg:root_mean_square_error instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointTorqueComparison>)))
  ...
  "franka_planner_control/JointTorqueComparison")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointTorqueComparison)))
  "Returns string type for a message object of type 'JointTorqueComparison"
  "franka_planner_control/JointTorqueComparison")
