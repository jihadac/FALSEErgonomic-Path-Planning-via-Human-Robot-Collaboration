...
if("TRUE" STREQUAL "TRUE")
  set(openpose_SOURCE_PREFIX /home/mainuser/Jihad/catkin_ws/src/openpose)
  set(openpose_DEVEL_PREFIX /home/mainuser/Jihad/catkin_ws/devel)
  set(openpose_INSTALL_PREFIX "")
  set(openpose_PREFIX ${openpose_DEVEL_PREFIX})
else()
  set(openpose_SOURCE_PREFIX "")
  set(openpose_DEVEL_PREFIX "")
  set(openpose_INSTALL_PREFIX /home/mainuser/Jihad/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'openpose' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'openpose' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mainuser/Jihad/catkin_ws/src/openpose/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT openpose_NUM_DUMMY_TARGETS)
      set(openpose_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::openpose::wrapped-linker-option${openpose_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR openpose_NUM_DUMMY_TARGETS "${openpose_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::openpose::wrapped-linker-option${openpose_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND openpose_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${openpose_dep}_FOUND)
      find_package(${openpose_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${openpose_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
