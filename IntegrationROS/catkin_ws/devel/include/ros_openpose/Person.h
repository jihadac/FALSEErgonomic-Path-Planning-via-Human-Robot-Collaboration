...
struct Person_
{
  ...
  _rightHandParts_type rightHandParts;
   ...
   typedef std::vector< ::ros_openpose::BodyPart_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ros_openpose::BodyPart_<ContainerAllocator> >::other >  _faceParts_type;
