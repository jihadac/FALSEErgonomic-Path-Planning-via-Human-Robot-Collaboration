...
class Person(genpy.Message):
  _md5sum = "719781611105baee252c1ac007e97ed7"
...
float32 y
float32 z"""
  __slots__ = ['bodyParts','leftHandParts','rightHandParts','faceParts']
  _slot_types = ['ros_openpose/BodyPart[]','ros_openpose/BodyPart[]','ros_openpose/BodyPart[]','ros_openpose/BodyPart[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       bodyParts,leftHandParts,rightHandParts,faceParts
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.rightHandParts:
        ...
        _x = _v6
        buff.write(_get_struct_3f().pack(_x.x, _x.y, _x.z))
      length = len(self.faceParts)
      buff.write(_struct_I.pack(length))
      for val1 in self.faceParts:
        _x = val1.score
        buff.write(_get_struct_f().pack(_x))
        _v7 = val1.pixel
        _x = _v7
